...
import { ChevronDown, Github, Mail, MapPin, Calendar } from "lucide-react"
...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted/50 pt-16 relative">
